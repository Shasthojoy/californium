...
public class TlsCorrelationContextMatcherTest {
	...
	@Before
	public void setup() {
		connectorContext = new TlsCorrelationContext("ID1", "S1", "C1");
		messageContext = new TlsCorrelationContext("ID1", "S1", "C1");
		differentMessageContext = new TlsCorrelationContext("ID2", "S2", "C1");
		matcher = new TlsCorrelationContextMatcher();
	}
